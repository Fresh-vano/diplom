...
\begin{xltabular}{\textwidth}{|X|X|c|X|}
	...
	\thead{Свойство} & \thead{Тип} & \thead{Обязательное} & \thead{Описание} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:Demo}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|c|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:MatchMinDto}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
	Id & int & true & Уникальный идентификатор матча \\ \hline
...
\begin{xltabular}{\textwidth}{|X|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:PlayerStatsDto}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:TeamRankDto}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:PlayersSheetFields}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
	Demo & package & *Analyzer.Demo & Демо-объект \\ \hline
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:PlayersSheetMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|c|c|X|}
	\caption{Спецификация полей класса Team}\label{table:TeamFields}\\ \hline
	\thead{Наименование} & \thead{Область \\ видимости} & \thead{Тип данных} & \thead{Описание} \\ \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:TeamFields}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|c|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:TeamMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|c|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:PlayerFields}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:PlayerMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:CountryIdsResolverFields}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:CountryIdsResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
	Resolve & public & Разрешает идентификатор страны из DTO турнира \\ \hline
\end{xltabular}

Класс ApplicationDbContext предназначен для управления доступом к данным базы данных о турнирах и командах.
...
\begin{xltabular}{\textwidth}{|X|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:ApplicationDbContextFields}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:ApplicationDbContextMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
Класс EntityMapper предназначен для маппинга DTO объектов на модели базы данных.
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:EntityMapperMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:TierResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:EventTypeResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
	Resolve & public & Разрешает тип события турнира из DTO \\ \hline
\end{xltabular}

Класс StageTypeResolver предназначен для разрешения типа этапа турнира из DTO.
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:StageTypeResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:ParsedStatusResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:TeamIdsResolverFields}} \hline
	\thead{1} & \thead{2} & \thead{3} & \thead{4} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:TeamIdsResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:MatchStatusResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
	Resolve & public & Разрешает статус матча из DTO \\ \hline
\end{xltabular}
...
\begin{xltabular}{\textwidth}{|X|X|X|}
	...
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endfirsthead
	\continuecaption{Продолжение таблицы \ref{table:StatusResolverMethods}} \hline
	\thead{1} & \thead{2} & \thead{3} \\ \hline
	\endhead
